...
export const ORDER_DETAIL_PATH = (orderId: string) => `/admin/orders/${orderId}`
export const ORDER_UPDATE_STATUS_PATH = (orderId: string) =>
  `/admin/orders/${orderId}/status`
export const ORDER_CANCEL_PATH = (orderId: string) => `/admin/orders/${orderId}/cancel`
export const ORDER_REFUND_PATH = (orderId: string) => `/admin/orders/${orderId}/refund`
...
export const ORDER_ADD_NOTE_PATH = (orderId: string) => `/admin/orders/${orderId}/notes`
